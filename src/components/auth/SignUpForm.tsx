  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <h1 className="font-display font-extrabold text-2xl text-[var(--text-heading)]">Create an account</h1>
        <p className="text-sm text-[var(--text-muted)] mt-1">Start tracking your job applications with AI</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-sm font-semibold text-[var(--text-heading)] mb-1.5">
            Confirm Password
          </label>
          <input
            id="confirmPassword"
        ...
        <Button type="submit" variant="primary" size="lg" className="w-full justify-center" disabled={loading || fetchStatus === "fetching"}>
          ...
          {loading || fetchStatus === "fetching" ? "Creating account..." : "Create Account"}
        </Button>
      </form>
