    ...
    <div className="flex flex-col sm:flex-row gap-3 bg-[var(--bg-surface)] p-3 sm:p-4 rounded-2xl border border-[var(--border)] shadow-sm">
      ...
      <div className="flex gap-2 items-center">
        <select
          ...
          className="p-2.5 pr-6 border border-[var(--border)] rounded-xl bg-[var(--input-bg)] text-xs text-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] cursor-pointer appearance-none"
          style={{
